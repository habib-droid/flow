...
import { Palette, Search, Image as ImageIcon, Zap, ShieldCheck, User, LogOut, LayoutDashboard, Settings } from 'lucide-react';
...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 glass flex items-center justify-between px-6 border-b border-white/5">
      <div className="flex items-center gap-8">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="font-bold text-xl tracking-tighter">Palette Wave</span>
        </Link>
